...
const Navbar = () => {
  ...
  return <header className={`flex justify-between p-5 top-0 z-0 shadow-md left-0 right-0 fixed bg-blue-200  `}>
    <div className="flex  ">
        ...
        rounded-md shadow-md items-center shadow-blue-500 hover:shadow-blue-800 leading-tight uppercase " >
    ...
    <p className="text-blue-900 font-bold" >Organization Vesting App</p>
    ...
    <div className="flex text-white ">
        ...
        { connectedAccount ? (
            <div className="hover:cursor-pointer bg-blue-500 px-5 py-2 hover:bg-blue-600
                rounded-full shadow-md  shadow-blue-500 hover:shadow-blue-800 leading-tight uppercase " >
