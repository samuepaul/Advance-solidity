      ...
      <div className="mt-32 flex justify-between">
        <div className="container mx-auto mt-8">
          ...
          <form className="max-w-md mx-auto bg-gray-200 shadow-md rounded px-8 py-6" onSubmit={orgSubmit}>
            ...
            <div className="mb-4">
              <label className="block text-blue-700 text-sm font-bold mb-2" htmlFor="number">
                Token
              </label>
              <input
                className="shadow appearance-none border rounded w-full py-2 px-3 text-blue-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div className="container mx-auto mt-8">
          <div className="max-w-md mx-auto flex font-semibold text-2xl items-center bg-blue-300 uppercase justify-center shadow-md rounded px-8 py-6 text-white">
            Add Stakeholder
          </div>
      ...
      <div className="flex justify-center items-center mt-10 mb-10">
        <div className="container mx-auto mt-8">
          ...
          <form className="max-w-md mx-auto bg-blue-200 shadow-md rounded px-8 py-6" onSubmit={whiteListSubmit}>
            <div className="mb-4">
              <label className="flex text-blue-700 text-sm font-bold mb-2 items-center justify-center" htmlFor="name">
                Address
              </label>
              <input
                className="shadow appearance-none border rounded w-full py-2 px-3 text-blue-700 leading-tight focus:outline-none focus:shadow-outline"
